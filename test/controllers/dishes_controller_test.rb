...
class DishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post dishes_url, params: { dish: { availablity: @dish.availablity, cost: @dish.cost, name: @dish.name } }
    end
  ...
  test "should update dish" do
    patch dish_url(@dish), params: { dish: { availablity: @dish.availablity, cost: @dish.cost, name: @dish.name } }
